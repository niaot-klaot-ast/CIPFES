    ...
    #--------------------------------------------------------------------1
        ...
        for i in range(len(chunk)-1):
            ...
            if order+order_init==100 and popt[delta_n+1+1]>2250 and flag==1 and i%2==0:
                ...
                fig.savefig('zfit1_sg.png', dpi=200)
                # plt.show()
                flag = 2
...
ax2.text(0.96, 0.9, r'$\epsilon=0.014$', va='center', ha='right', fontsize=10, transform=ax2.transAxes)
...
ax3.text(0.96, 0.9, r'$\epsilon=0.012$', va='center', ha='right', fontsize=10, transform=ax3.transAxes)
...
ax4.text(0.96, 0.9, r'$\epsilon=0.01$', va='center', ha='right', fontsize=10, transform=ax4.transAxes)
...
fig.savefig('zse1_sg.png', dpi=200)
...
ax22.text(0.96, 0.9, r'$\epsilon=0.014$', va='center', ha='right', fontsize=10, transform=ax22.transAxes)
...
ax23.text(0.96, 0.9, r'$\epsilon=0.012$', va='center', ha='right', fontsize=10, transform=ax23.transAxes)
...
ax24.text(0.96, 0.9, r'$\epsilon=0.01$', va='center', ha='right', fontsize=10, transform=ax24.transAxes)
...
ax32.text(0.96, 0.9, r'$\epsilon=0.014$', va='center', ha='right', fontsize=10, transform=ax32.transAxes)
...
ax33.text(0.96, 0.9, r'$\epsilon=0.012$', va='center', ha='right', fontsize=10, transform=ax33.transAxes)
...
ax34.text(0.96, 0.9, r'$\epsilon=0.01$', va='center', ha='right', fontsize=10, transform=ax34.transAxes)
...
ax42.text(0.96, 0.9, r'$\epsilon=0.014$', va='center', ha='right', fontsize=10, transform=ax42.transAxes)
...
ax43.text(0.96, 0.9, r'$\epsilon=0.012$', va='center', ha='right', fontsize=10, transform=ax43.transAxes)
...
ax44.text(0.96, 0.9, r'$\epsilon=0.01$', va='center', ha='right', fontsize=10, transform=ax44.transAxes)
...
fig.savefig('zse2_sg.png', dpi=200)
...
fig5.savefig('zsechunk_sg.png', dpi=200)
